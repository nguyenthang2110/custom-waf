...
khi tiến hành so khớp mẫu. Bộ luật ban đầu của hệ thống gồm 36 rule bao phủ
12 nhóm tấn công, được xây dựng theo cấu trúc JSON có phiên bản, dễ mở rộng
...
và tập luật 36 rules; pipeline fine-tuning DistilBERT với hard gate kiểm soát chất
