...
\usepackage{lmodern}      % font Latin Modern scalable mọi size; tránh lỗi "size 13 not available"
\usepackage{anyfontsize}  % silence các warning size lẻ còn sót cho package khác
...
\usepackage{outlines} % Cho phép môi trường outline với \1, \2, \3 trong Phụ lục
...
\usepackage{listings}
\usepackage{xcolor} % cần cho \definecolor trong lstlisting.tex
\usepackage{float}
...
% \usepackage{blindtext}  % không dùng, bỏ để compile nhanh hơn


% ===================================================

\renewcommand{\bibname}{Danh_sach_tai_lieu_tham_khao} 
\usepackage[backend=biber,style=ieee]{biblatex}  % biber nhanh hơn bibtex nhiều
...
% Bỏ \listoffigures khi đang viết để tiết kiệm 1 pass compile; bật lại trước khi nộp
% {\let\oldnumberline\numberline
...
% Bỏ \listoftables khi đang viết; bật lại trước khi nộp
% {\let\oldnumberline\numberline
% \renewcommand{\numberline}{Bảng~\oldnumberline}
% \listoftables}
% \phantomsection\addcontentsline{toc}{section}{\numberline {} DANH MỤC BẢNG BIỂU}

% \glsaddall  % bỏ khi đang viết để compile nhanh; bật lại trước khi nộp
...
\printnoidxglossary[type=\acronymtype] % chỉ in acronym list; main glossary trống nên không in
...
\subfile{Chuong/2_Khao_sat_phan_tich}
...
\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{THIẾT KẾ, TRIỂN KHAI VÀ KẾT QUẢ THỰC NGHIỆM}
\label{chapter:Experiment}
\subfile{Chuong/4_Thiet_ke_va_ket_qua}
